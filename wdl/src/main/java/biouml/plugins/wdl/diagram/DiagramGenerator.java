...
public class DiagramGenerator
{
    ...
    public Node createStruct(Compartment parent, StructInfo structInfo) throws Exception
    {
        ...
        List<ExpressionInfo> expressions = structInfo.getExpressions();
    ...
    public void createLinks(Diagram diagram)
    {
        for( Node node : diagram.recursiveStream().select( Node.class ).without( diagram ) )
        {
            ...
            Compartment enclosingWorkflow = WorkflowUtil.getEnclosingdWorkflow( node );
    ...
    public void createConditionalNodes(Compartment parent, ConditionalInfo conditional) throws Exception
    {
        ...
        for( String condition : conditional.getConditions() )
        {
            ...
            WorkflowUtil.setArguments( conditionNode, conditional.getArguments( condition ) );
