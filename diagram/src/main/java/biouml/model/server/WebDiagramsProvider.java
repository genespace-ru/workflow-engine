...
//                }
            ...
            else if( diagramAction.equals( "accept_for_reaction" ) )
            {
                ...
                String nodeName = arguments.getString( "node" );
                DiagramElement de = diagram.findDiagramElement( Util.toDiagramPath( nodeName ) );
//                if( de instanceof Node )
//                {
...
//                    + errors.stream().collect( Collectors.joining( ", " ) ) );
    ...
    public static View createView(Diagram diagram)
    {
        ...
        {   
            synchronized( diagram )
            {
                ...
                if( view == null )
                {
                    //TODO: refactor! code copied from ImageGenerator, should be placed to somewhere else
                    view = generateDiagramView( diagram, ApplicationUtils.getGraphics() );
    ...
    protected static void checkView(DiagramElement de)
    {
        if(de.getView() == null)
        {
            ...
            diagram.setView(null);
            generateDiagramView( diagram, ApplicationUtils.getGraphics() );
        }
    }
            ...
            throws WebException, IOException
    {
        ...
        response.sendString( "Not implemented yet" );
    }
            ...
            throws Exception
    {
        ...
        if( typeClass != null && typeClass != Stub.NoteLink.class
                && typeClass != SemanticRelation.class /*
                                                        * && typeClass !=
                                                        * Reaction.class
                                                        */ )
        {
    ...
    public static void sendType(Diagram diagram, OutputStream out) throws IOException
    {
        ...
        //        {
        //            diagramInfo.put("model", "true");
        //            diagramInfo.put("modelClass", model.getClass().getName());
        //        }
        //        else
        //        {
        diagramInfo.put( "model", "false" );
     ...
     */
    //TODO: commented UNDO-REDO and Transactions
