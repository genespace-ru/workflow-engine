...
public class DiagramEditorHelper implements ViewEditorHelper, TransactionListener
{
    ...
    private void logException(Throwable t, String deName, String parentName)
    {
        ...
        //TODO: refactored, BioUML application message bundle lines copied to biouml.model.workbench.MessageBundle
        else if( DefaultSemanticController.ERROR_NODE_IS_DUPLICATED.equals( t.getMessage() ) )
            message = messageBundle.getResourceString( "MESSAGE_NODE_ALREADY_EXIST" );
        else
            message = messageBundle.getResourceString( "CANNOT_MOVE_NODE_INTO_PARENT" );
    ...
    public Dimension resizeView(View view, Dimension size, Dimension offset) throws LoggedException
    {
        ...
        if( model instanceof Node )
        {
            ...
            Dimension shapeSize = ((Node) model).getShapeSize().getDimension();
    ...
    {
        //TODO: commented ActionInitializer
