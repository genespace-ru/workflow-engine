...
public abstract class DynamicAction implements Comparable<DynamicAction>
{
    ...
    public void setActionProperty(String propName, Object propValue)
    {
        actionProperties.put(propName, propValue);
    }

    public Object getValue(String name)
    {
        return actionProperties.get(name);
    }

    public void setActionProperties(Map<String, Object> properties)
    {
