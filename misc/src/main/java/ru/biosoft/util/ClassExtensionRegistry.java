...
public class ClassExtensionRegistry<T> extends ExtensionRegistrySupport<Class<? extends T>>
{
    ...
    @Override protected Class<? extends T> registerElement(String elementName, String className, Object... args) throws Exception
    {
        init();
        Class objClass = getClass(className, baseClass);
        addElementInternal(elementName, objClass);
        return objClass;
    }
    ...
    @Override public void addElement(String elementName, String className)
    {
        try
        {
            registerElement(elementName, className);
        }
        catch (Exception e)
        {
        }
