...
{
    public static final DataElementPath DEFAULT_MIRIAM_RESOURCE = DataElementPath.create( "databases/Utils/MIRIAM" );
    public static final String MIRIAM_PATH = "MIRIAMPath";
    ...
    public LinkResolver()
    {
        try
        {
            DataElementPath miriamPath = Environment.getValue( MIRIAM_PATH ) != null ? DataElementPath.create( (String) Environment.getValue( MIRIAM_PATH ) )
                    : DEFAULT_MIRIAM_RESOURCE;
            miriamCollection = miriamPath.getDataCollection( DatabaseInfo.class );
        }
